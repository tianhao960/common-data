package com.mars.faith.das.mybatis.plugin;
...
import com.mars.faith.das.dao.utils.ReflectionUtils;
import com.mars.faith.das.mybatis.builder.ShardConfigHolder;
import com.mars.faith.das.mybatis.builder.ShardConfigParser;
import com.mars.faith.das.mybatis.converter.SqlConverterFactory;
...
@CommonsLog
public class TablesShardPlugin implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		//TODO: I think here we can choose correct read or write datasource
		//for simple solution, if the sql start with "update", "insert" or "delete", then choose master datasource, otherwise, 
		//if sql start with "select", we should route the datasource to slaves datasources by roundrobin algorithm

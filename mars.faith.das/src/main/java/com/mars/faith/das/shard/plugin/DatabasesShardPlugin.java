package com.mars.faith.das.shard.plugin;
...
import com.mars.faith.das.shard.MyBatisShardException;
...
public class DatabasesShardPlugin implements Interceptor {
	...
	private MappedStatement buildMappedStatement(MappedStatement ms, BoundSql boundSql, String sql) {
		Builder builder = new MappedStatement.Builder(ms.getConfiguration(), ms.getId(), new BoundSqlSqlSource(ms,
	...
	public void setProperties(Properties properties) {
		...
		try {
			...
			throw new MyBatisShardException("Can not create dialect instance by dialect:" + dialectClass, e);
		}
	}

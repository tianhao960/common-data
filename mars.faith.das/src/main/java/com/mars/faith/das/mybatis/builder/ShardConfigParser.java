...
public class ShardConfigParser {
	...
	private static final String SHARD_CONFIG_DTD = "com/mars/faith/das/mybatis/builder/shard-config.dtd";
	private static final Map<String, String> DOC_TYPE_MAP = new HashMap<String, String>();

	static {
		DOC_TYPE_MAP.put("http://www.huoxing360.com/dtd/shardbatis-config.dtd".toLowerCase(), SHARD_CONFIG_DTD);
		DOC_TYPE_MAP.put("-//www.huoxing360.com//EN".toLowerCase(), SHARD_CONFIG_DTD);
	}
